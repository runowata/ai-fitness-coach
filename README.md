...
> **NOTE: AI functionality has been disabled** - All AI integration code has been commented out and replaced with demo plans.
...
* **~~Выбор AI-тренера~~ Выбор стиля тренера** из трех архетипов (Наставник, Профессионал, Ровесник)
* **~~AI-генерация плана~~ Демо-план тренировок** с 21-дневной программой
...
* **~~AI~~:** ~~OpenAI GPT-4 / Google Gemini~~ (Disabled)
