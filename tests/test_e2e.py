...
class EndToEndUserFlowTest(TestCase):
    ...
    def setup_test_data(self):
        ...
        self.exercise = Exercise.objects.create(
            ...
            difficulty="beginner",
            muscle_groups="chest,arms",  # Text field
    ...
    def test_complete_user_journey(self):
        ...
        self.assertTrue(hasattr(user, 'experience_points'))
        ...
        self.assertEqual(user.archetype, 'bro')
        ...
        # 14. Check user stats
        user.refresh_from_db()
        self.assertEqual(user.total_workouts_completed, 1)
        self.assertEqual(user.current_streak, 1)
        self.assertEqual(user.experience_points, 225)  # 100 from achievement + 125 from workout
        self.assertEqual(user.level, 3)  # 225 XP = level 3
    ...
    def test_workout_substitution_flow(self):
        ...
        # Link as alternative - DISABLED: field removed
...
def test_achievement_checking_service():
    ...
    # Set user stats
    user.total_workouts_completed = 5
    user.experience_points = 600
    user.save()
